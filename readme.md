...
- [GitHub Readme](https://github.com/michaelbragg/wp-starter-kit/blob/master/README.md)
- [Continuous Integration](https://codeship.com/projects/)
- [Local](http://www.wordpress.local/)
- [QA](#)
- [Production](#)
...
```
git clone https://github.com/michaelbragg/wp-starter-kit.git wp-starter-kit
cd wp-starter-kit
```
